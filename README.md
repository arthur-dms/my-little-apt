...
| `/send-message` | `message`, `device` (optional, default `*`) | Push a visible notification to the user's device |
...
| `send-notification` | `{"message": "..."}` | `NotificationManagerCompat` | Displays a visible notification to the end user |
